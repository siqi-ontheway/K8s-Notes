...
import (
	"context"
	siqidevv1alpha1 "kluster/pkg/apis/siqi.dev/v1alpha1"
	versioned "kluster/pkg/client/clientset/versioned"
	internalinterfaces "kluster/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "kluster/pkg/client/listers/siqi.dev/v1alpha1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SiqiV1alpha1().Klusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SiqiV1alpha1().Klusters(namespace).Watch(context.TODO(), options)
			},
		},
		&siqidevv1alpha1.Kluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *klusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&siqidevv1alpha1.Kluster{}, f.defaultInformer)
}
